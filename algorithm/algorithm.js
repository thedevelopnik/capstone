...
function match (school, teacher) {
  ...
  var ageMatch = matchAge(school.ages, teacher.ages).toFixed(2);
  if (ageMatch === (-1)) {
    return 0;
  }
  ...
  return calc.matchPercent(ageMatch, calMatch, locMatch, orgMatch, sizeMatch, stateMatch, trainingMatch, traitMatch);
}
